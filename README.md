...
Изучал языки C, С++, SQL, также делал проекты в направлении devops, больше всего меня зацепила Backend разработка и язык Go! Мне 25 лет, в свободное время хожу в зал и играю на барабанах :)
